    ...
    <div className="min-h-screen px-6 md:px-12 py-10" data-testid="home-page">
      ...
      {loading ? (
        ...
        <div className="kb-card p-10 text-center max-w-xl mx-auto" data-testid="empty-children">
          <p className="text-2xl font-heading mb-4">Aucun enfant pour l'instant</p>
        ...
        >
          {children.map((c, idx) => (
            ...
            >
              <div
                className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-white border-4 border-white shadow-lg flex items-center justify-center text-6xl md:text-7xl mb-4"
                aria-hidden
              >
                {c.emoji}
              </div>
